...
\begin{equation}
  \delta \theta = 1.22 \cdot \frac{3 \cdot 10^{8} \frac{\text{m}}{\text{s}}} {229.0707\,\text{GHz} \cdot 10000 \,\text{km}} = 1.598 \cdot 10^{-10} \mu \text{as} 
\end{equation}
...
\begin{align}
	...
	P(d|\xi) &=  {P(d_{ph}|\xi)\cdot P(d_{amp}|\xi)}\label{k4.2.likelihood}
\end{align}
